    ...
    <div class="container">
        ...
        <div class="overflow-auto">
            <div class="d-flex flex-nowrap mt-3">
                <div class="card product-card me-3" style="width: 18rem;">
                ...
                <!-- Repeat the card for more Baju Batik items -->
            </div>
        </div>
            ...
            <div class="overflow-auto">
                <div class="d-flex flex-nowrap mt-3">
                    <div class="card product-card me-3" style="width: 18rem;">
                        <img src="https://via.placeholder.com/150" class="card-img-top" alt="Product Image" />
                        <div class="card-body">
                            <h5 class="card-title fw-light text-truncate">Lorem, ipsum dolor sit amet consectetur
                                adipisicing elit. Quidem, nam?</h5>
                    ...
                    <!-- Repeat the card for more Kain Batik items -->
                </div>
            </div>
        </div>
    </div>
